...
import 'package:flutter_html_to_pdf/io/file_utils.dart';
...
class FlutterHtmlToPdf {
  ...
  /// Creates PDF Document from HTML content
  /// Can throw a [PlatformException] or (unlikely) a [MissingPluginException] converting html to pdf
  static Future<Uint8List?> convertHtmlToPdf(String htmlContent, {Size size = const Size(570,740),EdgeInsets margin = const EdgeInsets.all(20)}) async {
